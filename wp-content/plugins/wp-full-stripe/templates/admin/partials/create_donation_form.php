...
<h2 id="create-donation-form-tabs" class="nav-tab-wrapper wpfs-admin-form-tabs">
    <a href="#create-donation-form-tab-payment" class="nav-tab"><?php esc_html_e( 'Payment', 'wp-full-stripe-admin' ); ?></a>
    <a href="#create-donation-form-tab-appearance" class="nav-tab"><?php esc_html_e( 'Appearance', 'wp-full-stripe-admin' ); ?></a>
    <a href="#create-donation-form-tab-custom-fields" class="nav-tab"><?php esc_html_e( 'Custom Fields', 'wp-full-stripe-admin' ); ?></a>
    <a href="#create-donation-form-tab-actions-after-payment" class="nav-tab"><?php esc_html_e( 'Actions after payment', 'wp-full-stripe-admin' ); ?></a>
</h2>
    ...
    <div id="create-donation-form-tab-payment" class="wpfs-tab-content">
        <table class="form-table">
            <tr valign="top">
                ...
                <td><?php esc_html_e( 'Inline donation form', 'wp-full-stripe-admin' ); ?></td>
            </tr>
            <tr valign="top">
                <th scope="row">
    ...
    <div id="create-donation-form-tab-appearance" class="wpfs-tab-content">
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    <input type="text" class="regular-text" name="form_button_text" id="form_button_text" value="<?php esc_attr_e( 'Donate', 'wp-full-stripe-admin' ); ?>" maxlength="<?php echo $form_data::BUTTON_TITLE_LENGTH; ?>">
