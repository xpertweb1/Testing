...
class MM_WPFS_Countries {
	...
	public static function get_country_by_name( $countryName ) {
		if ( isset( $countryName ) ) {
			$availableCountries = self::get_available_countries();
	 ...
	 * @return null|string
	 */
	public static function get_country_name_for( $countryCode ) {
		if ( isset( $countryCode ) ) {
			$availableCountries = self::get_available_countries();
			if ( isset( $availableCountries ) && array_key_exists( $countryCode, $availableCountries ) ) {
