 ...
 * @property \StripeWPFS\BankAccount|null $active_account Hash describing the current account on the recipient, if there is one.
 * @property \StripeWPFS\Collection|null $cards
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string|\StripeWPFS\Card|null $default_card The default card to use for creating transfers to this recipient.
 ...
 * @property string|\StripeWPFS\Account|null $migrated_to The ID of the <a href="https://stripe.com/docs/connect/custom-accounts">Custom account</a> this recipient was migrated to. If set, the recipient can no longer be updated, nor can transfers be made to it: use the Custom account instead.
