 ...
 * @property \StripeWPFS\File|null $result <p>The file object representing the result of the report run (populated when</p><p><code>status=succeeded</code>).</p>
