 ...
 * @property string|\StripeWPFS\BalanceTransaction|null $balance_transaction ID of the balance transaction that describes the impact of this payout on your account balance.
 ...
 * @property string|\StripeWPFS\StripeObject|null $destination ID of the bank account or card the payout was sent to.
 * @property string|\StripeWPFS\BalanceTransaction|null $failure_balance_transaction If the payout failed or was canceled, this will be the ID of the balance transaction that reversed the initial balance transaction, and puts the funds from the failed payout back in your balance.
