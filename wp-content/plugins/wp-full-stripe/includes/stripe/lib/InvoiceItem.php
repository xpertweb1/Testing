 ...
 * @property string|\StripeWPFS\Invoice|null $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property \StripeWPFS\Plan|null $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 ...
 * @property string|\StripeWPFS\Subscription|null $subscription The subscription that this invoice item has been created for, if any.
 * @property string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property \StripeWPFS\TaxRate[]|null $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
