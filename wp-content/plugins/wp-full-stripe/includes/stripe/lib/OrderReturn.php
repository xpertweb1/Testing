 ...
 * @property string|\StripeWPFS\Order|null $order The order that this return includes items from.
 * @property string|\StripeWPFS\Refund|null $refund The ID of the refund issued for this return.
 *
 * @package StripeWPFS
 */
