 ...
 * @property string|\StripeWPFS\Charge|null $charge The charge associated with this review.
 ...
 * @property \StripeWPFS\StripeObject|null $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property \StripeWPFS\StripeObject|null $session Information related to the browsing session of the user who initiated the payment.
 *
 * @package StripeWPFS
 */
