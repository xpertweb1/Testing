 ...
 * @property string|\StripeWPFS\Product|null $product The product whose pricing this plan determines.
 * @property \StripeWPFS\StripeObject[]|null $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property \StripeWPFS\StripeObject|null $transform_usage Apply a transformation to the reported usage or set quantity before computing the billed price. Cannot be combined with <code>tiers</code>.
