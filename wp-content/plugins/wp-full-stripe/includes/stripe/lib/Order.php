 ...
 * @property string|\StripeWPFS\Charge|null $charge The ID of the payment used to pay for the order. Present if the order status is <code>paid</code>, <code>fulfilled</code>, or <code>refunded</code>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property string|\StripeWPFS\Customer|null $customer The customer used for the order.
 ...
 * @property \StripeWPFS\Collection|null $returns A list of returns that have taken place for this order.
 ...
 * @property \StripeWPFS\StripeObject|null $shipping The shipping address for the order. Present if the order is for goods to be shipped.
 * @property \StripeWPFS\StripeObject[]|null $shipping_methods A list of supported shipping methods for this order. The desired shipping method can be specified either by updating the order, or when paying it.
 ...
 * @property \StripeWPFS\StripeObject|null $status_transitions The timestamps at which the order status was updated.
