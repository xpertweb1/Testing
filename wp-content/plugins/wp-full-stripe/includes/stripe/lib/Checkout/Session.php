 ...
 * @property \StripeWPFS\StripeObject[]|null $display_items The line items, plans, or SKUs purchased by the customer.
 ...
 * @property string|\StripeWPFS\PaymentIntent|null $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property string|\StripeWPFS\SetupIntent|null $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 ...
 * @property string|\StripeWPFS\Subscription|null $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
