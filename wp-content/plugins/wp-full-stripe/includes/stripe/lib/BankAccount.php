 ...
 * @property string|\StripeWPFS\Account|null $account The ID of the account that the bank account is associated with.
 ...
 * @property string|\StripeWPFS\Customer|null $customer The ID of the customer that the bank account is associated with.
