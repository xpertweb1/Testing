 ...
 * @property string|\StripeWPFS\BalanceTransaction|null $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property string|\StripeWPFS\Account|null $destination ID of the Stripe account the transfer was sent to.
 ...
 * @property string|\StripeWPFS\Charge|null $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
