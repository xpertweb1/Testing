 ...
 * @property string|\StripeWPFS\StripeObject|null $application ID of the Connect application that created the PaymentIntent.
 ...
 * @property string|\StripeWPFS\Customer|null $customer <p>ID of the Customer this PaymentIntent belongs to, if one exists.</p><p>If present, payment methods used with this PaymentIntent can only be attached to this Customer, and payment methods attached to other Customers cannot be used with this PaymentIntent.</p>
 * @property string|null $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property string|\StripeWPFS\Invoice|null $invoice ID of the invoice that created this PaymentIntent, if it exists.
 * @property \StripeWPFS\ErrorObject|null $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \StripeWPFS\StripeObject $metadata Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format. For more information, see the <a href="https://stripe.com/docs/payments/payment-intents/creating-payment-intents#storing-information-in-metadata">documentation</a>.
 * @property \StripeWPFS\StripeObject|null $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 * @property string|\StripeWPFS\Account|null $on_behalf_of The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 * @property string|\StripeWPFS\PaymentMethod|null $payment_method ID of the payment method used in this PaymentIntent.
 * @property \StripeWPFS\StripeObject|null $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 ...
 * @property string|\StripeWPFS\Review|null $review ID of the review associated with this PaymentIntent, if any.
 ...
 * @property \StripeWPFS\StripeObject|null $shipping Shipping information for this PaymentIntent.
 * @property string|\StripeWPFS\StripeObject|null $source This is a legacy field that will be removed in the future. It is the ID of the Source object that is associated with this PaymentIntent, if one was supplied.
 ...
 * @property \StripeWPFS\StripeObject|null $transfer_data The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
