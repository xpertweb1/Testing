 ...
 * @property \StripeWPFS\StripeObject|null $authorization_controls Spending rules that give you some control over how this cardholder's cards can be used. Refer to our <a href="https://stripe.com/docs/issuing/authorizations">authorizations</a> documentation for more details.
 * @property \StripeWPFS\StripeObject $billing
 * @property \StripeWPFS\StripeObject|null $company Additional information about a <code>business_entity</code> cardholder.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string|null $email The cardholder's email address.
 * @property \StripeWPFS\StripeObject|null $individual Additional information about an <code>individual</code> cardholder.
