 ...
 * @property \StripeWPFS\StripeObject|null $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 ...
 * @property \StripeWPFS\StripeObject|null $renewal_interval This field has been deprecated. Interval and duration at which the subscription schedule renews for when it ends if <code>renewal_behavior</code> is <code>renew</code>.
 ...
 * @property string|\StripeWPFS\Subscription|null $subscription ID of the subscription managed by the subscription schedule.
 *
 * @package StripeWPFS
 */
