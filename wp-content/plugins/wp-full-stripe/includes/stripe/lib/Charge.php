 ...
 * @property string|\StripeWPFS\StripeObject|null $application ID of the Connect application that created the charge.
 * @property string|\StripeWPFS\ApplicationFee|null $application_fee The application fee (if any) for the charge. <a href="https://stripe.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 ...
 * @property string|\StripeWPFS\BalanceTransaction|null $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property string|\StripeWPFS\Customer|null $customer ID of the customer this charge is for if one exists.
 * @property string|null $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property string|\StripeWPFS\Account|null $destination ID of an existing, connected Stripe account to transfer funds to if <code>transfer_data</code> was specified in the charge request.
 * @property string|\StripeWPFS\Dispute|null $dispute Details about the dispute if the charge has been disputed.
 ...
 * @property \StripeWPFS\StripeObject|null $fraud_details Information on fraud assessments for the charge.
 * @property string|\StripeWPFS\Invoice|null $invoice ID of the invoice this charge is for if one exists.
 ...
 * @property string|\StripeWPFS\Account|null $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://stripe.com/docs/connect/charges-transfers">Connect documentation</a> for details.
 * @property string|\StripeWPFS\Order|null $order ID of the order this charge is for if one exists.
 * @property \StripeWPFS\StripeObject|null $outcome Details about whether the payment was accepted, and why. See <a href="https://stripe.com/docs/declines">understanding declines</a> for details.
 ...
 * @property \StripeWPFS\StripeObject|null $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property string|\StripeWPFS\Review|null $review ID of the review associated with this charge if one exists.
 * @property \StripeWPFS\StripeObject|null $shipping Shipping information for the charge.
 * @property \StripeWPFS\StripeObject|null $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property string|\StripeWPFS\Transfer|null $source_transfer The transfer ID which created this charge. Only present if the charge came from another Stripe account. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property \StripeWPFS\StripeObject|null $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
