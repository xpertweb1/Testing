 ...
 * @final
 */
class FnStream implements \Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
