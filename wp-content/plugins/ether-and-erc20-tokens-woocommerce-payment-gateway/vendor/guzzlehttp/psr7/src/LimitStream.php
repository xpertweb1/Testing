 ...
 * @final
 */
class LimitStream implements \Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
