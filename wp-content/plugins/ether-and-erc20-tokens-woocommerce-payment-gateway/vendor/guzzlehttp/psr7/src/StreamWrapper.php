...
class StreamWrapper
{
     ...
     */
    public static function getResource(\Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\Ethereumico\Epg\Dependencies\Psr\Http\Message\StreamInterface $stream)
    {
