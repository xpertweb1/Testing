...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \Ethereumico\Epg\Dependencies\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\Ethereumico\Epg\Dependencies\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\Ethereumico\Epg\Dependencies\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\Ethereumico\Epg\Dependencies\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\Ethereumico\Epg\Dependencies\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
     ...
     */
    public function __invoke(\Ethereumico\Epg\Dependencies\Psr\Http\Message\RequestInterface $request, array $options)
    {
