...
abstract class Base
{
     ...
     * @return object
     */
    public function convertInteger(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $x)
    {
    ...
    public function createRandomMultiplier()
    {
        ...
        $dA = \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger::randomRange($one, $this->order->subtract($one));
        return $this->factory->newInteger($dA);
    }
    /**
     * Sets the Order
     */
    public function setOrder(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger $order)
    {
        $this->order = $order;
    }
    /**
