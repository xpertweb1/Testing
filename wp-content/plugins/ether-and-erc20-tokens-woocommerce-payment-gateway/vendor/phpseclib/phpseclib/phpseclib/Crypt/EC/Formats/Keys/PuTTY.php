...
abstract class PuTTY extends \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\Common\Formats\Keys\PuTTY
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if ($components['curve'] instanceof \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards) {
            ...
            list($temp) = \Ethereumico\Epg\Dependencies\phpseclib3\Common\Functions\Strings::unpackSSH2('i', $private);
     ...
     * @return string
     */
    public static function savePrivateKey(\Ethereumico\Epg\Dependencies\phpseclib3\Math\Common\FiniteField\Integer $privateKey, \Ethereumico\Epg\Dependencies\phpseclib3\Crypt\EC\BaseCurves\Base $curve, array $publicKey, $password = \false, array $options = [])
    {
