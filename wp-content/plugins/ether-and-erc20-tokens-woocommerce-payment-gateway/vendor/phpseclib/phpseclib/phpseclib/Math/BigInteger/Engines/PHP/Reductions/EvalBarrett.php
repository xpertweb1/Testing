 ...
 */
namespace Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Base;
use Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @package PHP
 ...
 * @access  public
 */
abstract class EvalBarrett extends \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
     ...
     * @return callable
     */
    protected static function generateCustomReduction(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\PHP $m, $class)
    {
        if (isset($n->reduce)) {
