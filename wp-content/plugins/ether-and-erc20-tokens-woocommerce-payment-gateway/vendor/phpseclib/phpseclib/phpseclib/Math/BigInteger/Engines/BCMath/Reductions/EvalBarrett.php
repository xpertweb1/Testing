 ...
 */
namespace Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath\Reductions;

use Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath\Base;
 ...
 * @access  public
 */
abstract class EvalBarrett extends \Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath\Base
{
    /**
     ...
     */
    protected static function generateCustomReduction(\Ethereumico\Epg\Dependencies\phpseclib3\Math\BigInteger\Engines\BCMath $m, $class)
    {
        if (isset($n->reduce)) {
