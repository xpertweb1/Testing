...
function register_custom_menu_page() {
    add_menu_page('custom menu title', 'Popup menu', 'add_users', 'custompage', '_custom_menu_page', null, 6); 
}
add_action('admin_menu', 'register_custom_menu_page');

function _custom_menu_page(){
	echo"<h3>Popup Input Field</h3>";
   echo "<form id='myform' class='custom-pop' action='' method='post'>
